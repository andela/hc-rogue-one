...
urlpatterns = [
    ...
    url(r'^login_link_sent/$',
        views.login_link_sent,
        name="hc-login-link-sent"),
    url(r'^set_password_link_sent/$',
        views.set_password_link_sent,
        name="hc-set-password-link-sent"),
    ...
    url(r'^set_password/([\w-]+)/$',
        views.set_password,
        name="hc-set-password"),
    url(r'^switch_team/([\w-]+)/$', views.switch_team, name="hc-switch-team"),
]
